public class ConstructorOverloading{
    public static void main(String args[]){
        ...
        System.out.println(" The area of a rectangle in second constructor is :  " + areaInSecondConstructor);
        Rectangle rectangle3=new Rectangle(2.0f);
        float areaInThirdConstructor=rectangle3.third();
        System.out.println(" The area of a rectangle in third constructor is :  " + areaInThirdConstructor);
        Rectangle rectangle4=new Rectangle(3.0f,2.0f);
        float areaInFourthConstructor=rectangle4.fourth();
        System.out.println(" The area of a rectangle in fourth constructor is :  " + areaInFourthConstructor);
    }
}
